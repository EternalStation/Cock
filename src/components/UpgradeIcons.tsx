...
export const getIcon = (type: string, color: string) => {
    ...
    switch (type) {
        ...
        case 'reg_f': // Regen Health: Blue Heart + Filling Animation
            return (
                <svg viewBox="0 0 100 100" width="100%" height="100%" style={{ filter: `drop-shadow(0 0 3px #3B82F6)` }}>
                    <defs>
                        <mask id="regenMask">
        ...
        case 'reg_m': // Regen Multiplier: Filled + %
            return (
                <svg viewBox="0 0 100 100" width="100%" height="100%" style={{ filter: `drop-shadow(0 0 3px #3B82F6)` }}>
                    <defs>
