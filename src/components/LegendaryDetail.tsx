        ...
        <div style={{
            ...
            <div style={{
                ...
                {hex.perks && hex.perks.map((p, i) => {
                    const level = 1; // Not used now due to flat mapping
            ...
            {pending && (
                <div style={{
                    marginTop: 'auto', fontSize: '9px', color: color, fontWeight: 900,
                    textAlign: 'center', animation: 'pulse-accent 1s infinite alternate',
                    padding: '10px', letterSpacing: '1px', borderTop: '1px solid rgba(255,255,255,0.05)'
                }}>
